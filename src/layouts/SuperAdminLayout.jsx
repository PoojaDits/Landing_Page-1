...
import {
    LayoutDashboard, Activity, BarChart3, FileText, Store, PlusSquare,
    Users, ShieldCheck, UserPlus, KeyRound, Package, ShoppingCart,
    CreditCard, Truck, Sliders, Database, Plug, ScrollText, Settings,
    LogOut, Menu, X, Bell, Home, ChevronDown, User,
} from 'lucide-react';

const BG = 'linear-gradient(135deg, #1a0b2e 0%, #2d1b4e 50%, #0f3460 100%)';
...
export default function SuperAdminLayout({ handleLogout }) {
    ...
    const sections = [
        {
            ...
            items: [
                ...
                { icon: FileText, label: 'Global Reports', href: '/super-admin/reports' },
            ],
        },
        {
            label: 'Tenants',
            items: [
                { icon: Store, label: 'All Stores', href: '/super-admin/stores' },
                { icon: PlusSquare, label: 'Add Store', href: '/super-admin/stores/new' },
            ],
        },
        {
            label: 'Users & Access',
            items: [
                ...
                { icon: UserPlus, label: 'Add Admin', href: '/super-admin/admins/new' },
                { icon: KeyRound, label: 'Roles & Permissions', href: '/super-admin/roles' },
            ],
        },
        {
            label: 'Commerce',
            items: [
                ...
                { icon: ShoppingCart, label: 'All Orders', href: '/super-admin/orders' },
        ...
        },
        {
            label: 'System',
            items: [
                { icon: Sliders, label: 'Site Config', href: '/super-admin/config' },
                { icon: Database, label: 'Database', href: '/super-admin/database' },
                { icon: Plug, label: 'API Management', href: '/super-admin/api' },
                { icon: ScrollText, label: 'Audit Logs', href: '/super-admin/audit' },
    ...
    return (
        <div className="min-h-screen flex" style={{ background: BG }}>
            ...
            <aside
                className={cn(
                    'fixed top-0 left-0 z-50 h-full w-64 flex flex-col shrink-0 transition-transform duration-300 lg:translate-x-0 lg:relative',
                                    ...
                                    return (
                                        <li key={item.label + item.href}>
                                            <Link
                                                ...
                                                style={active ? { background: 'rgba(168, 85, 247, 0.18)' } : {}}
                                            >
                                                <Icon
                                                    className="w-4 h-4"
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <button className="relative p-2 rounded-lg text-gray-400 hover:text-white hover:bg-white/5">
                            ...
                            <span
                                ...
                                style={{ background: AC, borderColor: '#1a0b2e' }}
                            />
                        </button>
                            ...
                            {userMenuOpen && (
                                <>
                                    ...
                                    <div
                                        ...
                                        style={{ background: '#2d1b4e', borderColor: 'rgba(255,255,255,0.08)' }}
                                    >
